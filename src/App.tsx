        ...
        <div className="content-container">
          ...
          <div className='prep-container'>
            ...
            <ul>
              ...
              <li>
                <span>Preparation:</span> 5 minutes</li>
          ...
          <table>
            <tr>
              <td>Calories</td>
              <td className='bold-data'>277kcal</td>
            </tr>
            <tr>
              <td>Carbs</td>
              <td className='bold-data'>0g</td>
            </tr>
            <tr>
              <td>Protein</td>
              <td className='bold-data'>20g</td>
            </tr>
            <tr>
              <td>Fat</td>
              <td className='bold-data'>22g</td>
            </tr>
          </table>
        </div>
      </div>
